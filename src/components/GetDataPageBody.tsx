    ...
    render() {
        ...
        return (
            <div className='ms-welcome__main'>
                {/* <h2 className='ms-font-xl ms-fontWeight-semilight ms-fontColor-neutralPrimary ms-u-slideUpIn20'>You can insert or update the data to the Research Management System by clicking on the "Upload" button.</h2>
                */}
